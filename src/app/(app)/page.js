        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <CardContent className={`p-6 bg-gradient-to-br ${feature.color} border-0`}>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-2xl p-8">
                <div className="grid grid-cols-2 gap-4">
                  <Card className="p-4">
                    <div className="w-full h-32 bg-gradient-to-br from-amber-100 to-orange-200 rounded-lg flex items-center justify-center mb-3">
                  ...
                  <Card className="p-4">
                    <div className="w-full h-32 bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg flex items-center justify-center mb-3">
                      <Package className="w-8 h-8 text-primary" />
                    </div>
                  ...
                  <Card className="p-4">
                    <div className="w-full h-32 bg-gradient-to-br from-red-100 to-red-200 rounded-lg flex items-center justify-center mb-3">
                      <Package className="w-8 h-8 text-primary" />
                    </div>
